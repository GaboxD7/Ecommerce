...
//     constructor(id, nombre, genero, tipo, precio, talla, img, cantidad ) {
//         this.id = id;
//         this.nombre = nombre;
//         this.genero = genero;
//         this.tipo = tipo;
...
//                                     <button class="card-btnn" id="comprar${prod.id}" data-"${prod.id}" type="button">AGREGAR AL CARRITO</button>
//                                 </div>
//                             </div>`;
...
//      if(e.target.parentElement.parentElement === modal.parentElement.parentElement) {
//         modal.style.display = "none";
...
//         } else {
//             let nuevoProducto = (new Carrito(prod.id, prod.nombre, prod.genero, prod.tipo, prod.precio, prod.talla, prod.img, cant)) ;
...
//       tr.innerHTML = ` 
//     <tr>
//         <td><img src="${prod.imagen}" height=60px class="w-100"</td>
